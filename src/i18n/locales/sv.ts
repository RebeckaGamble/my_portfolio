export default {
  ...
  hero: {
    ...
    name: "Rebecka Gamble",
    title: "En junior frontend-utvecklare",
    description:
  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        title: "E-commerce",
        description:
          "E-commerce är en e-handelsplattform utvecklad i samarbete för att möjliggöra produktbläddring och köp. Funktioner inkluderar en produktkatalog, en dynamisk varukorg, en favoritsida och responsiv design.",
        fullDescription:
          "E-commerce är en e-handelsplattform utvecklad i samarbete för att möjliggöra produktbläddring och köp. Funktioner inkluderar en produktkatalog, en dynamisk varukorg, en favoritsida och responsiv design.",
        technologies: [
          {
      ...
      {
        title: "Portfolio",
        description: "Create a Portfolio using Next.js and Tailwind",
        fullDescription: "Create a Portfolio using Next.js and Tailwind",
        technologies: [
          {
            name: " Next.js",
            color: "green-text-gradient",
